...
/*
  There is a pull request in scalajs.dom for this to be added to the extensions library...
  I don't know why it hasn't been included yet, but I want to do keyboardy things...
  --Nick
 */
